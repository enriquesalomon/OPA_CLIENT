                    ...
                    If xdataTable.Rows.Count > 0 Then
                        For Each str As DataRow In xdataTable.Rows
                            ...
                            If mrow("examtype").ToString = "Essay" Then
                                ...
                                myadapter.SelectCommand = mycommand
                                myadapter.Fill(xYdataset, "examsubject_essay")
                                xYdataTable = xYdataset.Tables("examsubject_essay")
                                ...
                                MysqlConn.Open()
                                mycommand = MysqlConn.CreateCommand
                                mycommand.CommandText = "Select  Count(*) as num from  exam_answer_essay WHERE examid='" & mrow("id").ToString & "' and studentid='" & Globaluserid & "' and examsubjectid='" & subjectid & "'  "
                            ...
                            If mrow("examtype").ToString = "Multiple Choice" Then
                                xYdataTable.Rows.Clear()
                                xYdataset.Clear()
                                runServer()
                                MysqlConn.Open()
                                ...
                                myadapter.SelectCommand = mycommand
                                myadapter.Fill(xYdataset, "examsubject")
                                xYdataTable = xYdataset.Tables("examsubject")
                                If xYdataTable.Rows.Count > 0 Then
                                    For Each strS As DataRow In xYdataTable.Rows
                                        timelimit = strS("timelimit").ToString
                                    Next
                            ...
                            If mrow("examtype").ToString = "True or False" Then
                                xYdataTable.Rows.Clear()
                                xYdataset.Clear()
                                runServer()
                                MysqlConn.Open()
                                ...
                                myadapter.SelectCommand = mycommand
                                myadapter.Fill(xYdataset, "examsubject_truefalse")
                                xYdataTable = xYdataset.Tables("examsubject_truefalse")
                                If xYdataTable.Rows.Count > 0 Then
                                    For Each strS As DataRow In xYdataTable.Rows
                                        timelimit = strS("timelimit").ToString
                                    Next
                                ...
                                MysqlConn.Open()
                                mycommand = MysqlConn.CreateCommand
                                mycommand.CommandText = "Select  Count(*) as num from  exam_answer_truefalse WHERE examid='" & mrow("id").ToString & "' and studentid='" & Globaluserid & "' and examsubjectid='" & subjectid & "'  "

                                myadapter.SelectCommand = mycommand
                                myadapter.Fill(xYdataset, "exam_answer_truefalse")
                                xYdataTable = xYdataset.Tables("exam_answer_truefalse")
                                If xYdataTable.Rows.Count > 0 Then
                                    For Each strS As DataRow In xYdataTable.Rows
                                        examstatus = strS("num").ToString
                                    Next
