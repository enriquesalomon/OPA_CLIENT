...
Public Class ExamMaster
    ...
    Sub ExamList()
        ...
        While READER.Read()
            ...
            mycommand.CommandText = "SELECT e.id as id,ec.examcategoryname as examcategoryname,e.examtype as examtype FROM examcategory ec INNER JOIN exammaster e ON e.examcategoryid=ec.id WHERE e.examid='" & examineeexamid & "'"
            ...
            If mydataTable.Rows.Count > 0 Then
                For Each mrow As DataRow In mydataTable.Rows
                    ...
                    MysqlConn.Open()
                    mycommand = MysqlConn.CreateCommand
                    mycommand.CommandText = "Select  * from  examinee WHERE examid='" & examineeexamid & "' and studentid='" & Globaluserid & "'"
                    ...
                    Dim row As String() = New String() {mrow("id").ToString, mrow("examcategoryname").ToString + "year ", examsubjectname.ToString, mrow("examtype").ToString, timelimit, examstatus, examineeexamid}
